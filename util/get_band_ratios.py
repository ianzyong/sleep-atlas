...
plt.ylabel("Channel")
plt.xticks(range(int(duration)//int(args.interval_spacing_usec)+1),labels=[convertSeconds(offset_seconds+x) for x in range(int(0),int(duration/1000000),int(args.interval_spacing_usec/1000000))], fontsize=4, rotation = "vertical")
print(len(labels))
